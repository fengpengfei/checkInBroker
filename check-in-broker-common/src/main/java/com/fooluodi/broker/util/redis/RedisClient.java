package com.fooluodi.broker.util.redis;
...
public class RedisClient {
    ...
    public boolean setAnObject(String key, Object o) {
        Jedis client = jedisPool.getResource();
        try {
            String afterSerialize = JsonHelper.transObjToJsonString(o);
    ...
    public <T> T getSetT(String key, T newValue) {
        ...
        T t;
        try {
            String afterSerialize = JsonHelper.transObjToJsonString(newValue);
            String value = client.getSet(key, afterSerialize);
            t = (T) JsonHelper.transJsonStringToObj(value, newValue.getClass());
            return t;
        } finally {
            jedisPool.returnResource(client);// 向连接池“归还”资源
        }
    ...
    public <T> T getAnObject(String key, Class<T> zz) {
        ...
        try {
            ...
            t = JsonHelper.transJsonStringToObj(s, zz);
        } finally {
    ...
    public <T> boolean hset(String key, String field, T t) {
        Jedis client = jedisPool.getResource();
        try {
            String afterSerialize = JsonHelper.transObjToJsonString(t);
    ...
    public <T, S> boolean hmset(String key, Map<T, S> map) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                value = JsonHelper.transObjToJsonString(entry.getValue());
    ...
    public <T> T hgetObject(String key, String field, Class T) {
        ...
        try {
            ...
            return (T) JsonHelper.transJsonStringToObj(value, T);
        } finally {
            jedisPool.returnResource(client);// 向连接池“归还”资源
        }
     ...
     * @param expireTimeSec
     */
    public void expire(String key, int expireTimeSec) {
        Jedis client = jedisPool.getResource();

        try {
            Long expire = client.expire(key, expireTimeSec);
        } finally {
            jedisPool.returnResource(client);// 向连接池“归还”资源
        }
    }
