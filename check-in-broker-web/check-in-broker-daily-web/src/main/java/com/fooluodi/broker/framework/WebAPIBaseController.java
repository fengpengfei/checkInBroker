...
import com.fooluodi.broker.exception.ServiceException;
import com.fooluodi.broker.exception.SystemException;
import com.fooluodi.broker.util.BeanUtils;
...
public abstract class WebAPIBaseController {
    ...
    ResponseEntity<Map<String, Object>> handleServiceException(HttpServletRequest req,
        ...
        if (e.getErrorCode().equals("") || e.getErrorCode() == null)
            ...
            return new ResponseEntity<Map<String, Object>>(BeanUtils.killNull(e.getErrorCode()), e.getErrorMessage(), new HashMap<String, Object>());
    }
    ...
    public static class ValidationErrorSimple {
        ...
        public ValidationErrorSimple(ObjectError e) {
            ...
            this.message = MessageFormat.format(BeanUtils.killNull(e.getDefaultMessage()), e.getArguments());
            this.code = e.getCode();
    ...
    ResponseEntity<List<ValidationErrorSimple>> handleBindException(HttpServletRequest req,
        ...
        SystemException sysEx = new SystemException(WebAPIExceptions.ERR_WEBAPI_VALIDATION);
    ...
    ResponseEntity<String> handleThrowable(HttpServletRequest req, Throwable exception) {
        ...
        if (exception.getCause() instanceof ServiceException) {
            ServiceException midasServiceException = (ServiceException) exception.getCause();
            return new ResponseEntity<String>(midasServiceException.getErrorCode(), midasServiceException.getMessage(), null);
        } else {
            SystemException se = new SystemException(WebAPIExceptions.ERR_UNKNOWN);
